...
import downArrow from "../../assets/starter-code/assets/shared/icon-arrow-down.svg";
      ...
      {feedbacks ? (
        <>
          ...
          <div className="top-bar">
            ...
            <h4 className="total-suggestions">
          ...
          <div className="suggestion-list">
            {feedbacks.map((feedback) => {
              return (
                <Link key={feedback._id} to={`/details/${feedback._id}`}>
